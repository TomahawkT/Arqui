...
section  .text
         global   binary_search           ; Our program will start running from 'main'.
...
binary_search:
         ...
         mov   dh, [ebp+8]
         ;mov   right, BYTE [ebp+12]           ; DH will hold the number we are searching.
         ;lea   esi, [ebp+16]        ; Load effective address of 'arr' into esi.
